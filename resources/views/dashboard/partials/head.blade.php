<head>
    ...
    @if (Config::get('app.locale') == 'ar')
        ...
        <!-- Custom Actions CSS (RTL) -->
        <link rel="stylesheet" type="text/css" href="{{ asset('dashboard') }}/app-assets/css-rtl/custom-actions.css">
    @else
        ...
        <!-- Custom Actions CSS -->
        <link rel="stylesheet" type="text/css" href="{{ asset('dashboard') }}/app-assets/css/custom-actions.css">
    @endif
