            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <button type="button" class="btn btn-primary waves-effect" data-bs-toggle="modal"
                        ...
                        <i data-feather='plus'></i> {{ __('dashboard.create-admin') }}
                    </button>
                </div>
                @livewire('dashboard.admins.admins')
            </div>
        </div>
    </div>

    @livewire('dashboard.admins.add-admin')
    @livewire('dashboard.admins.update-admin')
@endsection
...
@push('js')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Cannot update
            Livewire.on('cannotUpdateAdmin', function() {
                Swal.fire({
                    position: 'top-start',
                    icon: 'error',
                    title: '{{ __('validation.something-valid') }}',
            ...
            Livewire.on('cannotDeleteMainAdmin', function() {
                Swal.fire({
                    position: 'top-start',
                    icon: 'error',
                    title: '{{ __('dashboard.cannot_delete_main_admin') }}',
                    text: '{{ __('dashboard.main_admin_protection') }}',
