<div class="row">
    ...
    <div class="col-md-6 mb-3">
        ...
        <input type="text" class="form-control @error('property_number') is-invalid @enderror"
            wire:model="property_number" placeholder="{{ __('dashboard.property_number') }}">
    ...
    <div class="col-md-6 mb-3">
        ...
        <input type="text" class="form-control @error('address_street') is-invalid @enderror"
            wire:model="address_street" placeholder="{{ __('dashboard.address_street') }}">
    ...
    <div class="col-md-6 mb-3">
        ...
        <input type="text" class="form-control @error('district_code') is-invalid @enderror"
            wire:model="district_code" placeholder="{{ __('dashboard.district_code') }}">
        @error('district_code')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="col-md-6 mb-3">
        ...
        <input type="number" step="0.01" class="form-control @error('area_land') is-invalid @enderror"
            wire:model="area_land" placeholder="{{ __('dashboard.area_land') }}">
        @error('area_land')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="col-md-6 mb-3">
        ...
        <input type="number" step="0.01" class="form-control @error('area_built') is-invalid @enderror"
            wire:model="area_built" placeholder="{{ __('dashboard.area_built') }}">
        @error('area_built')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="col-md-12 mb-3">
        ...
        <textarea class="form-control @error('boundaries') is-invalid @enderror" wire:model="boundaries" rows="2"
        ...
        <div class="row g-2">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control @error('specs.finishing.en') is-invalid @enderror"
                    wire:model="specs.finishing.en" placeholder="{{ __('dashboard.finishing_in_english') }}">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control @error('specs.finishing.ar') is-invalid @enderror"
                    wire:model="specs.finishing.ar" placeholder="{{ __('dashboard.finishing_in_arabic') }}">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control @error('specs.facade.en') is-invalid @enderror"
                    wire:model="specs.facade.en" placeholder="{{ __('dashboard.facade_in_english') }}">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control @error('specs.facade.ar') is-invalid @enderror"
                    wire:model="specs.facade.ar" placeholder="{{ __('dashboard.facade_in_arabic') }}">
            ...
            <div class="col-md-4">
                ...
                <input type="number" class="form-control @error('specs.floors') is-invalid @enderror"
                    wire:model="specs.floors" placeholder="{{ __('dashboard.floors') }}">
                @error('specs.floors')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            <div class="col-md-4">
                ...
                <input type="number" class="form-control @error('specs.rooms') is-invalid @enderror"
                    wire:model="specs.rooms" placeholder="{{ __('dashboard.rooms') }}">
                @error('specs.rooms')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="row mt-3">
                <div class="col-md-6">
                    <input type="checkbox" wire:model="specs.garden" class="form-check-input" id="garden">
                    <label for="garden">{{ __('dashboard.Has Garden') }}</label>
                </div>
                <div class="col-md-6">
                    <input type="checkbox" wire:model="specs.swimming_pool" class="form-check-input"
                        id="swimming_pool">
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="number" class="form-control @error('residential_buildings_count') is-invalid @enderror"
            wire:model="residential_buildings_count" placeholder="{{ __('dashboard.residential_buildings_count') }}">
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="number" class="form-control @error('administrative_buildings_count') is-invalid @enderror"
            wire:model="administrative_buildings_count" placeholder="{{ __('dashboard.administrative_buildings_count') }}">
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="number" class="form-control @error('total_users_count') is-invalid @enderror"
            wire:model="total_users_count" placeholder="{{ __('dashboard.total_users_count') }}">
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="number" class="form-control @error('treasurer_count') is-invalid @enderror"
            wire:model="treasurer_count" placeholder="{{ __('dashboard.treasurer_count') }}">
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="number" class="form-control @error('union_member_count') is-invalid @enderror"
            wire:model="union_member_count" placeholder="{{ __('dashboard.union_member_count') }}">
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="number" class="form-control @error('investors_count') is-invalid @enderror"
            wire:model="investors_count" placeholder="{{ __('dashboard.investors_count') }}">
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="number" class="form-control @error('owners_count') is-invalid @enderror"
            wire:model="owners_count" placeholder="{{ __('dashboard.owners_count') }}">
        @error('owners_count')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="number" class="form-control @error('tenants_count') is-invalid @enderror"
            wire:model="tenants_count" placeholder="{{ __('dashboard.tenants_count') }}">
        @error('tenants_count')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="text" class="form-control @error('bank_name') is-invalid @enderror"
            wire:model="bank_name" placeholder="{{ __('dashboard.bank_name') }}">
        @error('bank_name')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="text" class="form-control @error('bank_account_number') is-invalid @enderror"
            wire:model="bank_account_number" placeholder="{{ __('dashboard.bank_account_number') }}">
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="text" class="form-control @error('bank_iban') is-invalid @enderror"
            wire:model="bank_iban" placeholder="{{ __('dashboard.bank_iban') }}">
        @error('bank_iban')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
