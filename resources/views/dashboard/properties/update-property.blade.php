<x-updatecomponent title="{{ __('dashboard.update-property') }}">
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control @error('property_number') is-invalid @enderror"
                wire:model.live="property_number">
        ...
        <div class="col-md-6 mb-3">
            <label class="form-label">{{ __('dashboard.governorate') }}</label>
            ...
            <div class="row g-2">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('specs.finishing.en') is-invalid @enderror"
                        wire:model.live="specs.finishing.en" placeholder="{{ __('dashboard.finishing') }} (EN)">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('specs.finishing.ar') is-invalid @enderror"
                        wire:model.live="specs.finishing.ar" placeholder="{{ __('dashboard.finishing') }} (AR)">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" class="form-control @error('specs.bathrooms') is-invalid @enderror"
                        wire:model.live="specs.bathrooms" placeholder="{{ __('dashboard.bathrooms') }}">
                ...
                <div class="col-md-6 mt-3">
                    <input type="checkbox" wire:model.live="specs.garden" class="form-check-input" id="gardenUpdate">
                    <label for="gardenUpdate">{{ __('dashboard.Has Garden') }}</label>
                </div>

                <div class="col-md-6 mt-3">
                    <input type="checkbox" wire:model.live="specs.swimming_pool" class="form-check-input"
                        id="swimmingPoolUpdate">
                    <label for="swimmingPoolUpdate">{{ __('dashboard.Has Swimming Pool') }}</label>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12 mb-3">
            ...
            <textarea class="form-control @error('boundaries') is-invalid @enderror" wire:model.live="boundaries"
                rows="2"></textarea>
            @error('boundaries')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        ...
        <div class="col-md-12 mb-3">
            ...
            <select class="form-select @error('approved_by_admin_id') is-invalid @enderror"
                wire:model="approved_by_admin_id">
                <option value="">{{ __('dashboard.choose') }}</option>
                @foreach ($admins as $admin)
                    <option value="{{ $admin->id }}">{{ $admin->name }}</option>
                @endforeach
            </select>
            @error('approved_by_admin_id')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
