<x-updatecomponent title="{{ __('dashboard.update-subscription-plan') }}" size="modal-xl">
    <div class="row">
        <!-- الاسم بالإنجليزي -->
        ...
        <div class="col-md-4 mb-3">
            ...
            <div class="form-check form-switch mt-2">
                <input class="form-check-input" type="checkbox" wire:model="status" id="isActiveSwitchUpdate">
                <label class="form-check-label" for="isActiveSwitchUpdate">
        ...
        @foreach ($prices as $index => $price)
            <div class="col-12 mb-3" wire:key="update-price-{{ $index }}">
