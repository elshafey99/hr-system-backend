<x-createcomponent title="{{ __('dashboard.create-building') }}" class="btn-success">
    <div class="row">
        <div class="col-md-6">
            <div class="col-sm-6">
                <label class="col-form-label">{{ __('dashboard.name_en') }} <span class="text-danger">*</span></label>
            </div>
        ...
        <div class="col-md-6">
            <div class="col-sm-6">
                <label class="col-form-label">{{ __('dashboard.name_ar') }} <span class="text-danger">*</span></label>
            </div>
            <div class="form-group">
