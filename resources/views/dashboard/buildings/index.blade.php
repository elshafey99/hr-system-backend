@extends('dashboard.master', ['title' => __('dashboard.buildings')])
@section('buildings-active', 'active')
@section('buildings-open', 'open')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title mb-0">{{ __('dashboard.buildings') }}</h4>

                    <button type="button" class="btn btn-primary waves-effect" data-bs-toggle="modal" data-bs-target="#createModal">
                        <i data-feather='plus'></i> {{ __('dashboard.create-building') }}
                    </button>
                </div>

                @livewire('dashboard.buildings.buildings')

            </div>
        </div>
    </div>

    @livewire('dashboard.buildings.add-building')
    @livewire('dashboard.buildings.update-building')
@endsection
